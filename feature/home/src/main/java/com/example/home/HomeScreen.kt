...
@Composable
fun HomeContent(homeUiState: HomeUiState.Success, modifier: Modifier = Modifier, onGenreSelected: (GenreUiModel) -> Unit, onMovieClicked: (MovieWithGenreItem) -> Unit, onWatchlistClicked: (MovieWithGenreItem) -> Unit) {
    ...
    LazyVerticalStaggeredGrid(
        ...
        genreMovies(movies = homeUiState.genreMovies, onMovieClicked = onMovieClicked, onWatchlistClicked = onWatchlistClicked)
    }
}
