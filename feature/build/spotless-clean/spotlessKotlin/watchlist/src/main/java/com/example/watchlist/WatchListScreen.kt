...
fun WatchListScreen(modifier: Modifier = Modifier, viewModel: WatchListViewModel = hiltViewModel(), navigateToDetail: (MovieWithGenreItem) -> Unit) {
    ...
    when (uiState) {
        is WatchListUiState.Success -> WatchListContent(
            ...
            onSnackBarShown = {
                viewModel.onIntent(WatchListIntent.OnSnackBarShown)
            },
        )
...
@Composable
fun WatchListContent(watchListUiState: WatchListUiState.Success, shouldDisplayUndo: Boolean, modifier: Modifier = Modifier, onMovieClicked: (MovieWithGenreItem) -> Unit, onWatchlistClicked: (MovieWithGenreItem) -> Unit, onUndoClicked: () -> Unit, onSnackBarShown: () -> Unit) {
