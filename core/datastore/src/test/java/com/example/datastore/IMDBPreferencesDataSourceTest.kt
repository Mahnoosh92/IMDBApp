...
class IMDBPreferencesDataSourceTest {
    ...
    @Test
    fun `GIVEN default state WHEN initial flow read THEN dark theme defaults to FOLLOW_SYSTEM`() = testScope.runTest {
    ...
    @Test
    fun `GIVEN dark theme config set to LIGHT WHEN setDarkThemeConfig called THEN userData reflects LIGHT`() = testScope.runTest {
    ...
    @Test
    fun `GIVEN empty watchlist WHEN setWatchList called with items THEN userData watchList contains all items`() = testScope.runTest {
    ...
    @Test
    fun `GIVEN existing watchlist items WHEN setWatchList called with empty list THEN watchlist is cleared`() = testScope.runTest {
